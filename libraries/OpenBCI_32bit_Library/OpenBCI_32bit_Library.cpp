...
boolean OpenBCI_32bit_Library::boardBegin(void) {
	...
	// byte N_setting = RREG(LOFF_SENSN,BOARD_ADS);

	// leadOffSettings[0][NCHAN] = ON;
	// leadOffSettings[1][NCHAN] = ON;
	// leadOffSettings[2][NCHAN] = ON;
	// leadOffSettings[3][NCHAN] = ON;
	// leadOffSettings[4][NCHAN] = ON;
	// leadOffSettings[5][NCHAN] = ON;
	// leadOffSettings[6][NCHAN] = ON;
	// leadOffSettings[7][NCHAN] = ON;
	...
	// WREG(LOFF_SENSN,N_setting,BOARD_ADS);
...
void OpenBCI_32bit_Library::boardReset(void) {
    ...
    configureLeadOffDetection(LOFF_MAG_6NA, LOFF_FREQ_FS_4); // LOFF_FREQ_31p2HZ
